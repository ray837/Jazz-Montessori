...
<div className='flex flex-col justify-between gap-5 px-10 py-5 md:py-15 '>
...
<h1 className='font-[Fredoka]'>Visit us to experience how Jazz Montessori supports your child’s first and most important steps during the formative early years.</h1>
</div>
<div className='flex flex-col gap-10 px-10  py-5 md:py-15'> <h1 className='text-3xl  font-[Fredoka]'>Links</h1>
...
<div className='flex flex-col justify-between gap-5 px-10  py-5 md:py-15  font-[Fredoka]'>
    <h1 className='text-3xl font-bold font-[Fredoka]'>Contacts</h1>
    <h1 className='text-2xl font-semibold  font-[Fredoka]'>Email</h1>
    <a href="mailto:jazz.montessori1995@gmail.com?subject=Admission%20Enquiry&body=Hello%20Jazz%20Montessori%2C%0A%0AI%20would%20like%20to%20enquire%20about%20admissions.%0A%0AThank%20you.">jazz.montessori1995@gmail.com</a>
      ...
      <h1 className='text-2xl font-semibold  font-[Fredoka]'>Phone</h1>
    <a href="tel:+919686434225">(+91)9686434225</a>

     <h1 className='text-2xl font-semibold  font-[Fredoka]'>Address</h1>
    <a href='https://share.google/U7oxatchLrWkW4o4m' target='_blank'>Jayanagar 1st Block, Bangalore</a>
</div>
<div className='flex flex-col  gap-5 px-10  py-5 md:py-15'>
    <h1 className='text-3xl mb-5 font-bold font-[Fredoka]'>Enquire</h1>
    <p className='font-[Fredoka]'>If you would like to enquire , please reachout to our Whatsapp</p>
 <a href="https://wa.me/919686434225?text=Hello%20Jazz%20Montessori%2C%20I%20would%20like%20to%20enquire%20about%20admissions."
  ...
  className="w-1/2 border border-white text-white px-6 py-2 rounded-md active:scale-95 hover:bg-white hover:text-[#252340] font-[Fredoka] text-center">
    WhatsApp
  </a>
</div>
</div>
    </div>
    <div className='flex bg-[#252340] h-15 w-full text-white items-center justify-center text-sm font-light text-center font-[Fredoka]'>
<a href='https://www.linkedin.com/in/rayidahmed' target='_blank'>© 2018 Rayid Ahmed. All Rights Reserved. Designed & Developed By <span className='underline'>Rayid</span></a>
    </div>
    </>
  )
}
